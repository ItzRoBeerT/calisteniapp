...
export type EdgeConfigPanelProps = {
  ...
  handleEdgeConfigChange: (field: string, value: any) => void;
  closePanel: () => void;
};

export const EdgeConfigPanel: React.FC<EdgeConfigPanelProps> = ({ selectedEdge, colorOptions, arrowOptions, handleEdgeConfigChange, closePanel }) => (
