        ...
        <div>
          ...
          >
            ...
            <div className="text-left">
              <div className={`font-medium ${formState.is_public ? 'text-green-400' : 'text-yellow-400'}`}>
                {formState.is_public ? t('public') : t('private')}
              </div>
              <div className="text-xs text-foreground/60">
                {formState.is_public ? t('publicDescription') : t('privateDescription')}
              </div>
            </div>
          </button>
        </div>
